...
The script opens three WebSocket clients, verifies login, matching, 17-card hand delivery, landlord selection, a full landlord-led game, settlement delivery, then exits.
